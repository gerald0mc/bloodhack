...
public class Slider extends Component {
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.set.getDisplayName() + ": " + this.set.getValDouble() , (parent.parent.getX()* 2 + 15), (parent.parent.getY() + offset + 2) * 2 + 5, -1);
	...
	public void mouseReleased(int mouseX, int mouseY, int mouseButton) {
		dragging = false; BloodHack.configManager.SaveAll();
	}
