package dev.lors.bloodhack.clickgui.component.components.sub;
...
import static dev.lors.bloodhack.BloodHack.configManager;
...
public class Checkbox extends Component {
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.op.getDisplayName(), (parent.parent.getX() + 10 + 4) * 2 + 5, (parent.parent.getY() + offset + 2) * 2 + 4, -1);
		GL11.glPopMatrix();
	...
	public void mouseClicked(int mouseX, int mouseY, int button) {
		BloodHack.configManager.SaveAll();
		if (isMouseOnButton(mouseX, mouseY) && button == 0 && this.parent.open) {
			this.op.setValBoolean(!op.getValBoolean());;
			BloodHack.configManager.loadSettingsList();
		}
	}
